                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group @if($errors->has('thumbnail')) has-error @endif">
                            ...
                            {!! Form::text('thumbnail', $event->thumbnail, ['class' => 'form-control', 'placeholder' => 'Thumbnail']) !!}
                        ...
                        <div class="form-group @if($errors->has('sub_title')) has-error @endif">
                            ...
                            {!! Form::text('sub_title', $event->sub_title, ['class' => 'form-control', 'placeholder' => 'Sub Title']) !!}
                        ...
                        <div class="form-group @if($errors->has('details')) has-error @endif">
                            {!! Form::label('Details') !!}
                            {!! Form::textarea('details', $event->details, ['class' => 'form-control', 'placeholder' => 'Details']) !!}
